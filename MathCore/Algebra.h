...
DLLEXPORT double VieteSum(double a, double b);     // x1 + x2
DLLEXPORT double VieteProduct(double a, double c); // x1 * x2

// --- SEQUENCES ---
DLLEXPORT double ArithmeticSequenceTerm(double a1, double difference, int n);
DLLEXPORT double ArithmeticSequenceSum(double a1, double an, int n);
DLLEXPORT double GeometricSequenceTerm(double a1, double ratio, int n);
DLLEXPORT double GeometricSequenceSum(double a1, double ratio, int n);
DLLEXPORT double InfiniteGeometricSum(double a1, double q); // Suma szeregu nieskoñczonego
...
DLLEXPORT double CompoundInterest(double capital, double rate, int years); // Procent sk³adany
